    ...
    private async Task CreateBodyPartsMesures()
    {
        ...
        if (bodyParts == null || bodyParts.Count == 0)
        {
            var defaultBodyParts = new List<BodyParts>
            {
                ...
                new BodyParts { Name = "Shoulder",      Icon = "shoulder",      Mesure = 146 },
                new BodyParts { Name = "Back",          Icon = "back",          Mesure = 146 },
                ...
                new BodyParts { Name = "Left Calves",   Icon = "legs",          Mesure = 76 },
                new BodyParts { Name = "Right Calves",  Icon = "legs",          Mesure = 76 },
                new BodyParts { Name = "Left Thighs",   Icon = "tigh",        Mesure = 106 },
                new BodyParts { Name = "Right Thighs",  Icon = "tigh",        Mesure = 106 },
            };
